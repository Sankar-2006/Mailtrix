...
var rootCmd = &cobra.Command{
	Use:   "mailtrix",
	Short: "Mailtrix is an email testing tool for developers",
	Long: `Mailtrix is an email testing tool for developers.

It acts as an SMTP server, and provides a web interface to view all captured emails.

Documentation:
  https://github.com/krishpranav/Mailtrix
  https://github.com/krishpranav/Mailtrix/wiki`,
